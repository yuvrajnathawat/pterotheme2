...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The default language to use for the panel when no user preference is set.
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configuration for the Reverse Proxy addon.
    */
    'reverse_proxy' => [
    ...
    /*
    |--------------------------------------------------------------------------
    | Wings Agent Settings
    |--------------------------------------------------------------------------
    |
    | Configuration for Wings Agent addon connections.
    | Set WINGS_AGENT_VERIFY_TLS=true in .env to enable TLS certificate
    | verification for Wings Agent connections (recommended for production).
    */
    'wings_agent' => [
