...
class BackupTransformer extends BaseClientTransformer
{
    ...
    public function transform(Backup $backup): array
    {
        return [
            ...
            'is_external' => !empty($backup->agent_external_path) && !str_starts_with((string) $backup->agent_external_path, 'restic::'),
            'is_deduplicated' => (bool) ($backup->is_deduplicated ?? false),
        ];
    }
}
