...
use Pterodactyl\Models\RustMapLibrary;
...
class Server extends Model implements Identifiable
{
    ...
    protected $casts = [
        ...
        'server_type_changer_allowed' => 'boolean',
        'masterserver' => 'string',
        'suspended_by_account' => 'boolean',
     ...
     * @throws \Exception
     */
    public function location(): BelongsToThroughRelation
    {
    ...
    public function agentTransfer(): HasOne
    {
        return $this->hasOne(AgentServerTransfer::class)
