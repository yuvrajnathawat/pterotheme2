...
use Pterodactyl\Models\RolexDev\PermissionRole;
    ...
    Identifiable
{
    ...
    public static array $validationRules = [
        ...
        'referral_code' => 'nullable|string|between:1,64',
    ];
    ...
    {
        $data = Collection::make($this->toArray())->except(['id', 'external_id'])
        ...
        $data['has_global_view'] = $this->hasAdminPermission('rolex.global.view_all_servers');
    ...
    public function sendPasswordResetNotification($token)
    {
        ...
        try {
            ...
            // Do not fail password reset if mail delivery fails.
        }
    }
    ...
    /**
     * Determine if the account is currently suspended.
     */
    public function isSuspended(): bool
    {
        ...
        if ($this->suspended_until instanceof Carbon) {
    ...
    /**
     * Returns a human readable representation of how long the suspension lasts.
     */
    public function getSuspensionRemaining(): ?string
    {
        ...
        $now = Carbon::now();
        if ($now->greaterThanOrEqualTo($this->suspended_until)) {
            return null;
        }
