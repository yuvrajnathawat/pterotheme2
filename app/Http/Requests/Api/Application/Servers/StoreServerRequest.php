...
class StoreServerRequest extends ApplicationApiRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'feature_limits.splits' => 'sometimes|integer|min:0',
    ...
    public function validated($key = null, $default = null): array
    {
        ...
        return [
            ...
            'splits' => array_get($data, 'feature_limits.splits'),
            'reverse_proxy_limit' => array_get($data, 'feature_limits.reverse_proxy_limit'),
            'server_type_changer_allowed' => array_get($data, 'feature_limits.server_type_changer_allowed'),
