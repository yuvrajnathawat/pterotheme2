...
use Pterodactyl\Http\Controllers\Api\Client\Servers\Rolexdev\RecycleBinController;
...
class FileController extends ClientApiController
{
    ...
    private function calculateFolderSize(string $folderPath, Server $server): int
    {
        ...
        $maxTime = 2; // Maximum time allowed for calculation in seconds
    ...
    public function delete(DeleteFileRequest $request, Server $server): JsonResponse
    {
        ...
        if ($permanent) {
            ...
            $recycleBinController = app(RecycleBinController::class);
