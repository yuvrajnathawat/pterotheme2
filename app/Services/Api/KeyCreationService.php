...
use Illuminate\Database\ConnectionInterface; // Added this use statement
...
class KeyCreationService
{
    ...
    /**
     * KeyCreationService constructor.
     */
    public function __construct(
        private ConnectionInterface $connection, // Added this parameter
