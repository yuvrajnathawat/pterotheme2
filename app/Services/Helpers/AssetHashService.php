...
class AssetHashService
{
    ...
    /**
     * Return all preloads for core chunks.
     */
    public function preloads(): array
    {
        $manifest = $this->manifest();

        return array_filter($manifest, function ($key) {
            return str_starts_with($key, 'core.');
        }, ARRAY_FILTER_USE_KEY);
    }

    /**
     * Return preloads for auth-related chunks (login, register, etc.).
     */
    public function authPreloads(): array
    {
        $manifest = $this->manifest();

        return array_filter($manifest, function ($key) {
            return str_starts_with($key, 'auth.');
        }, ARRAY_FILTER_USE_KEY);
    }
