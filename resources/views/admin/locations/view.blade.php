        ...
        <div class="box box-primary">
            ...
            <form action="{{ route('admin.locations.view', $location->id) }}" method="POST">
                ...
                <div class="box-footer">
                    {!! csrf_field() !!}
                    {!! method_field('PATCH') !!}
                    @if(Auth::user()->root_admin || Auth::user()->hasAdminPermission('admin.locations.update'))
                    <button name="action" value="edit" class="btn btn-sm btn-primary pull-right">Save</button>
                    @endif
                    @if(Auth::user()->root_admin || Auth::user()->hasAdminPermission('admin.locations.delete'))
