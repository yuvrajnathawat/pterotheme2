...
const ServerConsoleContainer = () => {
    ...
    // Always include ALL Minecraft addons regardless of egg features
    const enhancedEggFeatures = useMemo(() => {
        const allMinecraftAddons = [
            'minecraft-version',
        ...
        const existing = Array.isArray(eggFeatures) ? eggFeatures : Object.values(eggFeatures || {});
        return Array.from(new Set([...existing, ...allMinecraftAddons]));
    }, [eggFeatures]);
    ...
    return (
        <ServerContentBlock title={'Console'}>
            ...
            <Features enabled={enhancedEggFeatures} />
        </ServerContentBlock>
    );
};
